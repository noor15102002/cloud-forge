...
func newVerifyCommand(stdout io.Writer, logger func() *slog.Logger, runner command.Runner) *cobra.Command {
	...
	cmd.Flags().StringVar(&baselinePath, "baseline", "", "compare with an explicit v1alpha1, v1alpha2, v1alpha3, v1alpha4, v1alpha5, v1alpha6 or v1alpha7 verification JSON file")
	return cmd
}
