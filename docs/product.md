...
The current release slice provides deterministic analysis, environment
diagnostics, and measured container-build and Deployment-readiness evidence in
an isolated k3d cluster. Additional runtime risks and comparison remain on the
roadmap.
