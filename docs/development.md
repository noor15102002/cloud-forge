...
the stable comment updater and validates the workflow and composite-action
metadata. The runtime integration workflow then exercises the root action on a
clean Ubuntu runner.
