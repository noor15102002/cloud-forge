...
- [ ] Correct root-user, probe, HPA, ORM, unresolved-port and nonregular-file verdicts.
- [ ] Preserve supported deployment semantics and reject unsupported settings before execution.
- [ ] Isolate kubeconfig and enforce replicas, CPU/memory and execution budgets.
- [ ] Support strict versioned endpoint/load configuration without fixture-specific query parameters.
- [ ] Record effective configuration, source/image identity and tool fingerprints before comparisons.
